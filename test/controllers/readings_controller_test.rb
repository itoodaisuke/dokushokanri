...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { book_id: @reading.book_id, comment: @reading.comment, finished_on: @reading.finished_on, started_on: @reading.started_on }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { book_id: @reading.book_id, comment: @reading.comment, finished_on: @reading.finished_on, started_on: @reading.started_on }
    assert_redirected_to reading_path(assigns(:reading))
  end
